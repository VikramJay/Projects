...
[~~**Find PI to the Nth Digit**~~](https://github.com/VikramJay/Projects/blob/findPiToTheNthDigit/findPiToTheNthDigit/findPi.py) - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[~~**Fibonacci Sequence**~~](https://github.com/VikramJay/Projects/blob/fibonacciSequence/fibonacciSequence/fib.py) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
